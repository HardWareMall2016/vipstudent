...
public class PhotoUtils {
  ...
  public static DisplayImageOptions buldDisplayImageOptions(int defImgRes,int cornerRadiusPixels) {
    DisplayImageOptions.Builder builder = new DisplayImageOptions.Builder()
            .showImageOnLoading(defImgRes)
            .showImageForEmptyUri(defImgRes)
    ...
    if (cornerRadiusPixels > 0) {
      builder.displayer(new RoundedBitmapDisplayer(cornerRadiusPixels));//是否设置为圆角，弧度为多少
    }
