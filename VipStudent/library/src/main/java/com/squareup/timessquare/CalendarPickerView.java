...
public class CalendarPickerView extends ListView {
    ...
    private OnInvalidDateSelectedListener invalidDateListener = null;
    ...
    public void setCellClickListener(MonthView.Listener listener) {
    ...
    public void setCellClicked(boolean b) {
        this.cellClicked = b;
    }

    public CellClickInterceptor getCellClickInterceptor(){return cellClickInterceptor;}

    public FluentInitializer init(Date minDate, Date maxDate, Locale locale, HashMap<Date, String> dataMap) {
    ...
    public void setOnFragmentClickListener(FragmentClickListener fragmentClickListener) {
    ...
    private class CellClickedListener implements MonthView.Listener {
        ...
        public void handleClick(View v, MonthCellDescriptor cell) {
            ...
            if (cellClickInterceptor != null && cellClickInterceptor.onCellClicked(v, clickedDate)) {
                return;
            }
    ...
    private class MonthAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (monthView == null) {
//        dayBackgroundResId = android.R.color.white;
                monthView =
                        MonthView.create(parent, inflater, weekdayNameFormat, listener, today, dividerColor,
                                dayBackgroundResId, dayTextColorResId, titleTextColor, false,
    ...
    public interface CellClickInterceptor {
        boolean onCellClicked(View v, Date date);
    }
